...
public class ProgrammerAdditionAndSubtractionTest {
    ...
    public void programmerAdditionWORD_isCorrect() {
        assertEquals(10, ProgrammerUtil.addSubtract(WORD, 5, 5));
        assertEquals(-10, ProgrammerUtil.addSubtract(WORD, -5, -5));
        assertEquals(0, ProgrammerUtil.addSubtract(WORD, (short) 0x4000, -(short) 0x4000));
        assertEquals(0, ProgrammerUtil.addSubtract(WORD, (short) 0x8000, (short) 0x8000));
        assertEquals((short) 0x7FFF, ProgrammerUtil.addSubtract(WORD, -(short) 0x8000, -1));
        assertEquals((short) 0x8000, ProgrammerUtil.addSubtract(WORD, (short) 0x7FFF, 1));
        assertEquals(0, ProgrammerUtil.addSubtract((WORD), (short) 0xFFFF, 1));
        assertEquals((short) 0x8000,ProgrammerUtil.addSubtract(WORD, (short) 0x4000,(short) 0x4000));
    }
    @Test
    public void programmerAdditionBYTE_isCorrect() {
        assertEquals(10, ProgrammerUtil.addSubtract(BYTE, 5, 5));
        assertEquals(-10, ProgrammerUtil.addSubtract(BYTE, -5, -5));
        assertEquals(0, ProgrammerUtil.addSubtract(BYTE, (byte) 0x40, -(byte) 0x40));
        assertEquals(0, ProgrammerUtil.addSubtract(BYTE, (byte) 0x80, (byte) 0x80));
        assertEquals((byte) 0x7F, ProgrammerUtil.addSubtract(BYTE, -(byte) 0x80, -1));
        assertEquals((byte) 0x80, ProgrammerUtil.addSubtract(BYTE, (byte) 0x7F, 1));
        assertEquals(0, ProgrammerUtil.addSubtract((BYTE), (byte) 0xFF, 1));
        assertEquals((byte) 0x80,ProgrammerUtil.addSubtract(BYTE, (byte) 0x40,(byte) 0x40));
    }
}
