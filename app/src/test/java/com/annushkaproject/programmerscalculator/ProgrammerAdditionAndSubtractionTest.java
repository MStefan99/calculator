...
import static com.annushkaproject.programmerscalculator.model.Operator.SUBSTRUCT;
...
public class ProgrammerAdditionAndSubtractionTest {
    ...
    public void programmerAdditionQWORD_isCorrect() {
        ...
        assertEquals(-10, ProgrammerUtil.calculateWithData(new ProgrammerCalcModel(new Value(-5), new Value(5), SUBSTRUCT, QWORD)));
        assertEquals(0, ProgrammerUtil.calculateWithData(new ProgrammerCalcModel(new Value(0x4000000000000000L), new Value(0x4000000000000000L), SUBSTRUCT, QWORD)));
        ...
        assertEquals(0x7FFFFFFFFFFFFFFFL, ProgrammerUtil.calculateWithData(new ProgrammerCalcModel(new Value(-0x8000000000000000L), new Value(1), SUBSTRUCT, QWORD)));
    ...
    assertEquals(-10, ProgrammerUtil.calculateWithData(new ProgrammerCalcModel(new Value(-5), new Value(5), SUBSTRUCT, DWORD)));
        assertEquals(0, ProgrammerUtil.calculateWithData(new ProgrammerCalcModel(new Value(0x40000000), new Value(0x40000000), SUBSTRUCT, DWORD)));
        ...
        assertEquals(0x7FFFFFFF, ProgrammerUtil.calculateWithData(new ProgrammerCalcModel(new Value(-0x80000000), new Value(1), SUBSTRUCT, DWORD)));
    ...
    public void programmerAdditionWORD_isCorrect() {
        ...
        assertEquals((short) -10, ProgrammerUtil.calculateWithData(new ProgrammerCalcModel(new Value(-5), new Value(5), SUBSTRUCT, WORD)));
        assertEquals((short) 0, ProgrammerUtil.calculateWithData(new ProgrammerCalcModel(new Value(0x4000), new Value(0x4000), SUBSTRUCT, WORD)));
        assertEquals((short) 0, ProgrammerUtil.calculateWithData(new ProgrammerCalcModel(new Value(0x8000), new Value(0x8000), ADD, WORD)));
        assertEquals((short) 0x7FFF, ProgrammerUtil.calculateWithData(new ProgrammerCalcModel(new Value(-0x8000), new Value(1), SUBSTRUCT, WORD)));
    ...
    public void programmerAdditionBYTE_isCorrect() {
        ...
        assertEquals((byte) -10, ProgrammerUtil.calculateWithData(new ProgrammerCalcModel(new Value(-5), new Value(5), SUBSTRUCT, BYTE)));
        assertEquals((byte) 0, ProgrammerUtil.calculateWithData(new ProgrammerCalcModel(new Value(0x40), new Value(0x40), SUBSTRUCT, BYTE)));
        assertEquals((byte) 0, ProgrammerUtil.calculateWithData(new ProgrammerCalcModel(new Value(0x80), new Value(0x80), ADD, BYTE)));
        assertEquals((byte) 0x7F, ProgrammerUtil.calculateWithData(new ProgrammerCalcModel(new Value(0x80), new Value(1), SUBSTRUCT, BYTE)));
