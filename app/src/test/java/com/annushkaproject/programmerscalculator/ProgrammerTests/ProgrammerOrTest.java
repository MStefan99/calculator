...
//            assertEquals(0, ProgrammerOperationsUtil.calculateWithData(new ProgrammerCalcModel(new Value(0), new Value(0), OR, mode)));
//            assertEquals(1, ProgrammerOperationsUtil.calculateWithData(new ProgrammerCalcModel(new Value(1), new Value(0), OR, mode)));
//            assertEquals(-1, ProgrammerOperationsUtil.calculateWithData(new ProgrammerCalcModel(new Value(-1), new Value(1), OR, mode)));
//            assertEquals(-1, ProgrammerOperationsUtil.calculateWithData(new ProgrammerCalcModel(new Value(-1), new Value(-1), OR, mode)));
//        }
    }
}
