...
public enum Operator {
    ...
    CHANGE_SIGN,     LSH,     RSH,     NOT,     OR,     XOR,     AND,     MOD,
    ...
    public static Operator operatorForTitle(String title) {
        switch (title) {
            ...
            case "÷": return Operator.DIVIDE; case "%": return Operator.PERCENT; case "And": return Operator.AND; case "Or": return Operator.OR;
            case "Xor": return Operator.XOR; case "Not": return Operator.NOT; case "Lsh": return Operator.LSH; case "Rsh": return Operator.RSH;
            case "sinˉ¹": return Operator.ASIN; case "cosˉ¹": return Operator.ACOS; case "tanˉ¹": return Operator.ATAN; case "sin":       return Operator.SIN;
            case "cos": return Operator.COS; case "tan": return Operator.TAN; case "ln": return Operator.LN; case "log": return Operator.LOG;
      case "1/x": return Operator.DENOMINATOR; case "eˣ": return Operator.EXPONENT_POWER;             case "x²":       return Operator.SQUARE;             case "xʸ":       return Operator.POWER;
      case "|x|": return Operator.ABS; case "√": return Operator.SQUARE_ROOT; case "x!": return Operator.FACTORIAL;
    ...
    public boolean requiresTwoValues() {
        switch (this) {
            ...
            case XOR:             case MOD:             case POWER:       return true;
            default:       return false;
        }
    }
    public static int getNumberByOperator(Operator operator) {
        switch (operator) {
            case ADD:   return 0;   case SUBTRACT:   return 1;   case MULTIPLY:   return 2;   case DIVIDE:   return 3;
            ...
            case MOD:   return 12;   case ASIN:   return 13;   case ACOS:   return 14;   case ATAN:   return 15;
    ...
    public static Operator getOperatorByNumber(int number) {
        switch (number) {
            case 0: return ADD; case 1: return SUBTRACT; case 2: return MULTIPLY; case 3: return DIVIDE;
            ...
            case 12: return MOD; case 13: return ASIN; case 14: return ACOS; case 15: return ATAN;
